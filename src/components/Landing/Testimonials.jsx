...
function TestimonialCard({ item }) {
  return (
    <div className="glass rounded-2xl p-6 flex flex-col justify-between w-80 flex-shrink-0 mx-2">
      <div>
...
export default function Testimonials() {
  ...
  return (
    <section id="iskustva" className="py-28 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight">
            {lang === 'sr' ? 'Šta kažu naši korisnici' : 'What our users say'}
          </h2>
        </FadeUp>
      </div>
