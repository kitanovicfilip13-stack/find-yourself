  ...
  const segments = [
    {
      id: 'srednja',
      title: 'Srednja škola',
      desc: 'Pomažemo ti da odabereš pravi tip srednje škole na osnovu tvojih interesovanja i načina razmišljanja.',
      icon: (
    ...
    },
    {
      ...
      desc: 'Pronađi karijerni pravac koji odgovara tvojoj ličnosti, snagama i vrednostima.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
