      ...
      <div className="flex min-h-[calc(100vh-73px)]">
        ...
        <div className="hidden md:flex flex-col w-56 border-r border-white/5 px-4 py-8 flex-shrink-0">
          {[
            ...
            { id: 'zadaci', label: 'Moji zadaci', icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg> },
        ...
        {activeTab === 'zadaci' && (
          <div>
            ...
            <p className="text-white/30 text-sm mb-8">Zadaci iz tvog plana razvoja koje treba da završiš.</p>
            {plan && plan.length > 0 ? (
              <div className="space-y-3">
                {plan.map((task, i) => (
