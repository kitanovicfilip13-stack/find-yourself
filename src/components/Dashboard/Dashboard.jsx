        ...
        `} style={{ background: 'rgba(8,8,16,0.98)', backdropFilter: 'blur(20px)' }}>
          ...
          <div className="pt-6 border-t border-white/5 space-y-1">
            ...
            <button onClick={onRetake}
              className={`flex items-center gap-3 py-2.5 rounded-xl text-sm text-white/30 hover:text-white/70 hover:bg-white/8 transition-all w-full overflow-hidden ${sidebarOpen ? 'px-3 text-left' : 'px-0 justify-center'}`}>
            ...
            <button onClick={() => { signOut(); onGoToLanding() }}
              className={`flex items-center gap-3 py-2.5 rounded-xl text-sm text-white/30 hover:text-red-400 hover:bg-red-500/5 transition-all w-full overflow-hidden ${sidebarOpen ? 'px-3 text-left' : 'px-0 justify-center'}`}>
