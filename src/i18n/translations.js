  ...
  sr: {
      ...
      steps: [
        {
          ...
          desc: 'Pitanja pokrivaju tvoje vrednosti, interesovanja, energiju i ambicije. Nema tačnih ni pogrešnih odgovora.',
          tag: '8 minuta',
          accent: 'text-violet-400',
        },
        {
        ...
        },
        {
          ...
          desc: 'Tip ličnosti, tvoji najveći potencijali, karijerni pravci koji ti odgovaraju, veštine koje vredi razvijati i konkretan plan za prvih 7 dana.',
    ...
    what: {
      ...
      features: [
        ...
        { icon: '📅', title: 'Plan za prvih 7 dana', desc: 'Konkretni koraci koje možeš da uradiš već ove nedelje kako bi rezultate pretvorio u stvaran napredak.' },
        { icon: '🎯', title: 'Tvoj sledeći korak', desc: 'Jedan jasan pravac od kojeg možeš da počneš, umesto da ostaneš zaglavljen između previše izbora.' },
      ],
    },
