  ...
  sr: [
    {
      ...
      options: [
        { text: "Potpuno iscrpljeno. Treba mi vreme nasamo da se napunim.", scores: { I: 2 } },
    ...
    },
    {
      ...
      question: "Kada imaš veliki projekat pred sobom, koji pristup ti deluje najprirodniji?",
      options: [
        ...
        { text: "Odmah zaronim i učim dok radim.", scores: { R: 2, N: 1 } },
        { text: "Razgovaram sa nekim da razbistrим misli.", scores: { P: 2, E: 1 } },
      ],
    },
    {
      ...
      options: [
        ...
        { text: "Čitanje, istraživanje i duboko zaranjanje u temu koja me fascinira.", scores: { T: 2, O: 1 } },
    ...
    },
    {
      ...
      question: "Šta te od ovog najviše nervira na poslu ili na fakultetu?",
      options: [
    ...
    },
    {
      ...
      question: "Kako se osećaš prema tehnologiji, kodu i digitalnim sistemima?",
      options: [
        { text: "Obožavam to — želim da razumem kako stvari funkcionišu i da ih gradim.", scores: { T: 3 } },
        { text: "Koristim je kao alat, ali me ne zanima tehnička strana.", scores: { T: 1 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Radije sarađuješ kao ravnopravan član — bez hijerarhije.", scores: { P: 1, E: 1 } },
        { text: "Voliš da daješ individualni doprinos i povremeno da se povesuješ sa drugima.", scores: { I: 1, T: 1 } },
        { text: "Najefikasnije radiš potpuno sam/a — drugi te ometaju.", scores: { I: 2 } },
      ],
    },
    {
      id: 8, category: 'Rizik',
      ...
      options: [
        { text: "Uspevam zahvaljujući njima — neizvesnost znači prilike.", scores: { R: 3, B: 1 } },
        ...
        { text: "Hoću stabilnost — rizik me previše stresuje.", scores: { S: 2, O: 1 } },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Slušam intuiciju — ako se osećа ispravno, idem na to.", scores: { R: 1, C: 1 } },
        { text: "Pričam sa ljudima kojima verujem i razmotrim njihove perspektive.", scores: { P: 2 } },
    ...
    },
    {
      ...
      options: [
        { text: "Vizuelni dizajn, fotografija, film — stvari koje možeš da vidiš i osetиш.", scores: { C: 3 } },
    ...
    },
    {
      ...
      question: "Na koji način najboуe učiš?",
      options: [
        { text: "Čitam, gledam, upijam informacije sopstvenim tempom.", scores: { I: 1, T: 1 } },
        { text: "Radeći — učim kroz greške i iteracije.", scores: { N: 1, R: 1, C: 1 } },
        { text: "Posmatram i zatim kopиram nekoga ko je već dobar u tome.", scores: { P: 1 } },
        { text: "Strukturirani kursevi sa jasnim planom i prekretnicama.", scores: { O: 2, S: 1 } },
      ],
    },
    {
    ...
    },
    {
      ...
      question: "Kako se osećaš prema prodaji, ubeđivanju ili marketingu ideja?",
      options: [
        { text: "Obožavam to — prirodно sam dobar/a u ubeđivanju.", scores: { B: 3, E: 1 } },
        { text: "Mogu da to radim kada verujem u proizvod.", scores: { B: 1, P: 1 } },
        { text: "Nije moja stvar — radije pustim da rad govori sam za sebe.", scores: { I: 1, C: 1, T: 1 } },
        { text: "Osećam se nelagodno, kao da manipulišem.", scores: { P: 1 } },
      ],
    },
    {
      ...
      options: [
        ...
        { text: "Biti svetski klasa u veštini — priznat/a stručnjak/inja.", scores: { T: 2, O: 1 } },
        { text: "Direktno pomažem hiljadama ljudi — kroz servis, praksu ili misiju.", scores: { P: 3 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Finansijska nestabilnost — ne moći da platim račune.", scores: { S: 2 } },
        { text: "Živeti konvencionalan život i nikada ne uraditi nešto za pamćenje.", scores: { R: 2, C: 1 } },
      ],
    },
    {
      ...
      options: [
        ...
        { text: "Fokusiran, seniorski tim gde se ceni duboka ekspertiza.", scores: { T: 2, O: 1 } },
        { text: "Organizacija sa misijom koja radi na društvenim ili ekološkim pitanjima.", scores: { P: 2, N: 1 } },
        { text: "Sopstveni studio ili frilenserska praksa — potpuna autonomija.", scores: { C: 2, I: 1, R: 1 } },
      ],
    },
    {
      id: 18, category: 'Snage',
      question: "Po čemu te ljudi najčešće traže?",
      options: [
        { text: "Savet, emotivna podrška ili pomoć u rešavanju problema.", scores: { P: 3 } },
        { text: "Kreativni input — žele moj ukus, ideje ili oko.", scores: { C: 3 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Podučavajući, koučujući ili mentorišući ljude da dostignu potencijal.", scores: { P: 3 } },
        { text: "Istražujući prirodu, praveći fizičke predmete ili radeći rukama.", scores: { N: 3 } },
      ],
    },
    {
      id: 20, category: 'Prvi korak',
      question: "Upravo si odlučio/la za novi pravac. Šta je tvoj prvi potez?",
      options: [
