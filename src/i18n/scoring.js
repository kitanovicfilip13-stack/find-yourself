...
const typeData = {
  ...
  sr: {
    ...
    C_P: { name: 'Vizionar', emoji: '◎', tagline: 'Vidiš ono što drugi još ne vide — i teraš ljude da u to poveruju.', color: '#ec4899' },
    C_B: { name: 'Marketar', emoji: '⬡', tagline: 'Razumeš šta ljude pokreće i znaš kako da im to kažeš.', color: '#f59e0b' },
    ...
    T_C: { name: 'Tvorac Proizvoda', emoji: '⬟', tagline: 'Pretvараš ideje u proizvode koji zaista postoje.', color: '#8b5cf6' },
    ...
    T_N: { name: 'Strateg', emoji: '◎', tagline: 'Razmišljaš nekoliko koraka unapred i gradiš sisteme koji pobeđuju.', color: '#10b981' },
    ...
    P_O: { name: 'Povezivač', emoji: '⬟', tagline: 'Dovodiš prave ljude zajedno u pravo vreme.', color: '#10b981' },
    P_N: { name: 'Iscelitelj', emoji: '✦', tagline: 'Pomažeš ljudima i živim bićima da napreduju.', color: '#10b981' },
    B_C: { name: 'Tvorac Brenda', emoji: '◎', tagline: 'Razumeš čežnju — i znaš kako da je stvoriš.', color: '#f59e0b' },
    B_T: { name: 'Tehno-Preduzetnik', emoji: '⬡', tagline: 'Vidiš praznine na tržištu i puniš ih proizvodima.', color: '#3b82f6' },
    B_P: { name: 'Prodavac', emoji: '◆', tagline: 'Pretvараš razgovore u dogovore. To ti dolazi prirodno.', color: '#f59e0b' },
