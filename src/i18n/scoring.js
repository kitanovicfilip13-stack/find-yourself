...
const typeData = {
  en: {
    ...
    C_P: { name: 'The Visionary', emoji: '◎', tagline: 'You see what others don\'t yet — and make people believe in it.', color: '#ec4899' },
    C_B: { name: 'The Marketer', emoji: '⬡', tagline: 'You understand people\'s desires and know how to speak to them.', color: '#f59e0b' },
    ...
    T_N: { name: 'The Strategist', emoji: '◎', tagline: 'You think several moves ahead and build systems that win.', color: '#10b981' },
    ...
    P_O: { name: 'The Connector', emoji: '⬟', tagline: 'You bring the right people together at the right time.', color: '#10b981' },
    ...
    B_P: { name: 'The Salesperson', emoji: '◆', tagline: 'You turn conversations into deals. It comes naturally to you.', color: '#f59e0b' },
  ...
  sr: {
    C_T: { name: 'Digitalni Kreator', emoji: '✦', tagline: 'Kombinuješ vizuelni dizajn sa tehničkim znanjem. Baviš se pravljenjem digitalnih sadržaja, interfejsa i proizvoda koji izgledaju dobro i zaista rade.', jobs: ['UI/UX Dizajner', 'Web Dizajner', 'Motion Designer', 'Grafički Dizajner', 'Digitalni Ilustrator'], color: '#8b5cf6' },
    C_P: { name: 'Vizionar', emoji: '◎', tagline: 'Razvijaš ideje pre nego što postanu stvarnost i ubeđuješ druge da u njih poveruju. Baviš se strategijom, brendingom i kreiranjem nečeg novog od nule.', jobs: ['Product Manager', 'Creative Director', 'Brand Strategist', 'Startup Osnivač', 'Content Strateg'], color: '#ec4899' },
    C_B: { name: 'Marketar', emoji: '⬡', tagline: 'Razumeš šta pokreće ljude da kupe ili prate nešto. Baviš se komunikacijom, reklamama, sadržajem i izgradnjom publike.', jobs: ['Content Creator', 'Social Media Manager', 'Marketing Manager', 'Copywriter', 'Brand Manager'], color: '#f59e0b' },
    C_O: { name: 'Arhitekta', emoji: '▣', tagline: 'Struktuiraš kompleksne stvari — prostorno ili sistemski — tako da i izgledaju dobro i funkcionišu. Baviš se planiranjem, dizajnom i organizacijom.', jobs: ['Arhitekta', 'Interior Dizajner', 'UX Dizajner', 'Information Architect', 'Prostorni Planer'], color: '#06b6d4' },
    C_N: { name: 'Majstor', emoji: '◈', tagline: 'Praviš stvari rukama visokim kvalitetom i pažnjom prema detaljima. Baviš se zanatom, fotografijom, filmom ili fizičkim dizajnom.', jobs: ['Fotograf', 'Videograf', 'Grafički Dizajner', 'Ilustrator', 'Zanatlija'], color: '#10b981' },
    T_C: { name: 'Tvorac Proizvoda', emoji: '⬟', tagline: 'Praviš softverske proizvode koje koriste pravi korisnici. Baviš se programiranjem, ali te zanima i kako se to koristi u praksi.', jobs: ['Full-Stack Developer', 'Software Engineer', 'Mobile Developer', 'Product Engineer', 'Indie Developer'], color: '#8b5cf6' },
    T_P: { name: 'Tehnički Lider', emoji: '◆', tagline: 'Gradiš tehničke sisteme i koordiniraš tim koji to sprovodi. Baviš se i kodom i ljudima — i dobro te ide u oba.', jobs: ['Tech Lead', 'Engineering Manager', 'Software Architect', 'CTO', 'Scrum Master'], color: '#3b82f6' },
    T_B: { name: 'Osnivač', emoji: '✦', tagline: 'Možeš i da napraviš i da prodaš sopstveni proizvod. Baviš se startupima, tech biznisom i izgradnjom kompanije od nule.', jobs: ['Startup Osnivač', 'Tech Entrepreneur', 'Product Manager', 'Indie Hacker', 'SaaS Osnivač'], color: '#f59e0b' },
    T_O: { name: 'Inženjer', emoji: '⬡', tagline: 'Rešavaš tehničke probleme precizno i sistematično. Baviš se razvojem softvera, infrastrukturom ili podacima.', jobs: ['Backend Developer', 'DevOps Engineer', 'Data Engineer', 'Systems Engineer', 'Cloud Engineer'], color: '#06b6d4' },
    T_N: { name: 'Strateg', emoji: '◎', tagline: 'Razmišljaš unapred i praviš planove koji su tehnički izvodljivi. Baviš se analizom, planiranjem sistema i rešavanjem kompleksnih problema.', jobs: ['IT Konsultant', 'Systems Analyst', 'Solution Architect', 'Technical Strategist', 'Business Analyst'], color: '#10b981' },
    P_C: { name: 'Dizajner Iskustva', emoji: '◈', tagline: 'Praviš okruženja i iskustva koja se dobro osećaju za korisnike. Baviš se istraživanjem korisnika, dizajnom interfejsa i uslužnim dizajnom.', jobs: ['UX Researcher', 'Experience Designer', 'Service Designer', 'UX Writer', 'Customer Experience Manager'], color: '#ec4899' },
    P_T: { name: 'UX Specijalista', emoji: '◆', tagline: 'Brineš se da digitalni proizvodi budu razumljivi i ugodni za korišćenje. Baviš se dizajnom korisničkog iskustva, testiranjem i istraživanjem.', jobs: ['UX Designer', 'Product Designer', 'UX Researcher', 'Interaction Designer', 'Usability Tester'], color: '#8b5cf6' },
    P_B: { name: 'Lider', emoji: '▣', tagline: 'Vodiš ljude i timove ka cilju. Baviš se upravljanjem projektima, HR-om, operacijama ili vođenjem organizacije.', jobs: ['Project Manager', 'Team Lead', 'HR Manager', 'Operations Manager', 'People Manager'], color: '#3b82f6' },
    P_O: { name: 'Povezivač', emoji: '⬟', tagline: 'Dovodiš prave ljude zajedno i gradiš mreže koje funkcionišu. Baviš se partnerstvima, zajednicama i poslovnim razvojem.', jobs: ['Community Manager', 'Partnership Manager', 'PR Specijalista', 'Business Developer', 'Event Manager'], color: '#10b981' },
    P_N: { name: 'Iscelitelj', emoji: '✦', tagline: 'Pomažeš ljudima da se osećaju bolje — fizički, mentalno ili emotivno. Baviš se psihologijom, zdravljem, edukacijom ili socijalnim radom.', jobs: ['Psiholog', 'Life Coach', 'HR Specijalista', 'Socijalni Radnik', 'Edukator'], color: '#10b981' },
    B_C: { name: 'Tvorac Brenda', emoji: '◎', tagline: 'Gradiš prepoznatljive brendove kroz vizuelni identitet, poruke i strategiju. Baviš se marketingom, brendingom i kreiranjem publike.', jobs: ['Brand Manager', 'Marketing Director', 'Creative Director', 'Brand Strategist', 'Content Director'], color: '#f59e0b' },
    B_T: { name: 'Tehno-Preduzetnik', emoji: '⬡', tagline: 'Pronalaziš prilike na tržištu i popunjavaš ih tehnološkim rešenjima. Baviš se startupima, tech proizvodima i poslovnim razvojem.', jobs: ['Tech Entrepreneur', 'Startup Osnivač', 'Product Manager', 'Venture Builder', 'Growth Hacker'], color: '#3b82f6' },
    B_P: { name: 'Prodavac', emoji: '◆', tagline: 'Pretvaraš razgovore u dogovore i gradiš poslovne odnose. Baviš se prodajom, akvizicijom klijenata i pregovaranjem.', jobs: ['Sales Manager', 'Account Executive', 'Business Developer', 'Sales Consultant', 'Account Manager'], color: '#f59e0b' },
    B_O: { name: 'Operativac', emoji: '▣', tagline: 'Vodiš kompleksne operacije i sisteme u kompaniji. Baviš se procesima, efikasnošću i koordinacijom između timova.', jobs: ['COO', 'Operations Manager', 'Business Analyst', 'Process Manager', 'General Manager'], color: '#06b6d4' },
    B_N: { name: 'Preduzetnik', emoji: '✦', tagline: 'Gradiš sopstveni posao oko veština i resursa koje imaš. Baviš se pokretanjem i vođenjem malog ili srednjeg biznisa.', jobs: ['Small Business Owner', 'Entrepreneur', 'Freelancer', 'Konsultant', 'Franchise Owner'], color: '#f59e0b' },
    O_C: { name: 'Art Direktor', emoji: '◈', tagline: 'Vodiš kreativne projekte i osiguravaš vizuelnu konzistentnost. Baviš se dizajnom, brendingom i koordinacijom kreativnih timova.', jobs: ['Art Director', 'Creative Director', 'Brand Designer', 'Visual Designer', 'Marketing Manager'], color: '#8b5cf6' },
    O_T: { name: 'Analitičar Podataka', emoji: '⬟', tagline: 'Pronalaziš smislene obrasce u podacima i pomažeš da se donose bolje odluke. Baviš se analizom, vizualizacijom podataka i izveštavanjem.', jobs: ['Data Analyst', 'Business Analyst', 'BI Analyst', 'Data Scientist', 'Reporting Specialist'], color: '#3b82f6' },
    O_P: { name: 'Menadžer Projekata', emoji: '◆', tagline: 'Osiguravaš da pravi ljudi rade prave stvari u pravo vreme. Baviš se koordinacijom timova, rokovima i isporukom projekata.', jobs: ['Project Manager', 'Scrum Master', 'Program Manager', 'Delivery Manager', 'Operations Coordinator'], color: '#06b6d4' },
    O_B: { name: 'Operativni Direktor', emoji: '▣', tagline: 'Pretvараš viziju kompanije u konkretne rezultate. Baviš se strategijom, procesima i upravljanjem organizacijom.', jobs: ['COO', 'General Manager', 'Strategy Consultant', 'Operations Director', 'Managing Director'], color: '#f59e0b' },
    O_N: { name: 'Specijalista', emoji: '✦', tagline: 'Savladaš jednu oblast do detalja i postaješ osoba kojoj svi dolaze za savet. Baviš se dubokim stručnim radom u svom domenu.', jobs: ['Domain Expert', 'Senior Specialist', 'Technical Consultant', 'Subject Matter Expert', 'Senior Analyst'], color: '#10b981' },
    N_C: { name: 'Tvorac', emoji: '◎', tagline: 'Praviš fizičke ili vizuelne stvari sa puno pažnje i kvaliteta. Baviš se zanatom, fotografijom, filmom ili industrijskim dizajnom.', jobs: ['Fotograf', 'Videograf', 'Industrial Designer', 'Product Designer', 'Craftsman'], color: '#10b981' },
    N_T: { name: 'Primenjeni Naučnik', emoji: '◆', tagline: 'Primenjaš naučna znanja na rešavanje stvarnih problema. Baviš se istraživanjem, tehničkim radom i praktičnom naukom.', jobs: ['Lab Technician', 'Research Engineer', 'Environmental Engineer', 'Applied Scientist', 'Field Researcher'], color: '#3b82f6' },
    N_P: { name: 'Kouč', emoji: '⬡', tagline: 'Vodiš ljude kroz izazove i pomažeš im da napreduju. Baviš se koučingom, fitnesom, edukacijom ili mentalnim zdravljem.', jobs: ['Life Coach', 'Personal Trainer', 'Sports Coach', 'Wellness Consultant', 'Mentor'], color: '#10b981' },
    N_B: { name: 'Osnivač', emoji: '▣', tagline: 'Gradiš sopstveni posao oko praktičnih veština i resursa. Baviš se pokretanjem biznisa u realnom sektoru.', jobs: ['Trade Business Owner', 'Entrepreneur', 'Farm/Food Business', 'Sustainability Konsultant', 'Craftsman Osnivač'], color: '#f59e0b' },
    N_O: { name: 'Ekspert', emoji: '✦', tagline: 'Postaneš neophodni stručnjak u svom fizičkom ili tehničkom domenu. Baviš se dubokim praktičnim radom i postižeš majstorstvo.', jobs: ['Master Craftsman', 'Technical Expert', 'Field Specialist', 'Senior Technician', 'Domain Master'], color: '#10b981' },
    default: { name: 'Istraživač', emoji: '◎', tagline: 'Prelaziš granice između različitih oblasti i lako prilagodiš svoje veštine novim situacijama.', jobs: ['Konsultant', 'Generalist', 'Researcher', 'Freelancer', 'Entrepreneur'], color: '#8b5cf6' },
  },
}
...
const careerData = {
  ...
  sr: [
    { label: 'UX / Dizajn proizvoda', desc: 'Dizajniraš digitalne proizvode i interfejse koji su laki za korišćenje. Uključuje istraživanje korisnika, skiciranje rešenja i testiranje.', weights: { C: 2, T: 1.5, P: 0.5 } },
    { label: 'Softversko inženjerstvo', desc: 'Pišeš kod i razvijaš softverske aplikacije — od web sajtova do mobilnih aplikacija i kompleksnih sistema.', weights: { T: 2.5, O: 1, C: 0.5 } },
    { label: 'Brend & Marketing', desc: 'Gradiš prepoznatljivost kompanija i proizvoda kroz reklamiranje, sadržaj, dizajn identiteta i komunikaciju sa kupcima.', weights: { C: 1.5, B: 2, P: 0.5 } },
    { label: 'Kreiranje sadržaja / Mediji', desc: 'Praviš tekstove, videe, podkaste i druge formate za publiku. Bazirano na pričanju priča i izgradnji zajednice.', weights: { C: 2, P: 1, B: 0.5 } },
    { label: 'Preduzetništvo', desc: 'Pokrećeš i vodiš sopstveni biznis. Tražiš prilike, preuzimeš rizike i sam/a donosiš odluke o pravcu razvoja.', weights: { B: 2.5, R: 1.5, T: 0.5 } },
    { label: 'Podaci & Analitika', desc: 'Analiziraš podatke da pomogneš kompanijama da donose bolje odluke. Uključuje statistiku, vizualizaciju i izveštavanje.', weights: { T: 2, O: 1.5 } },
    { label: 'Upravljanje ljudima / HR', desc: 'Baviš se regrutovanjem, razvojem i blagostanjem zaposlenih. Igraš ključnu ulogu u kulturi i funkcionisanju kompanije.', weights: { P: 2.5, O: 1 } },
    { label: 'Upravljanje proizvodom', desc: 'Koordiniraš razvoj digitalnih proizvoda između timova. Decidiš šta se gradi, zašto i kada, i pratiš rezultate.', weights: { T: 1, P: 1.5, O: 1.5, B: 0.5 } },
    { label: 'Konsalting & Strategija', desc: 'Pomažeš kompanijama da reše kompleksne poslovne probleme. Analiziraš situaciju i predlažeš konkretna rešenja.', weights: { B: 2, O: 1.5, P: 0.5 } },
    { label: 'Kreativna direkcija', desc: 'Vodiš vizuelni i kreativni identitet brendova ili projekata. Upravljaš kreativnim timovima i postavljaš estetski smer.', weights: { C: 2.5, B: 1 } },
    { label: 'Obrazovanje & Kouching', desc: 'Pomažeš ljudima da nauče i razviju se — u učionici, online ili kroz lični kouching i mentorstvo.', weights: { P: 2.5, C: 0.5, O: 0.5 } },
    { label: 'Arhitektura / Inženjerstvo', desc: 'Dizajniraš fizičke strukture ili tehničke sisteme — od zgrada do mašina i infrastrukture.', weights: { N: 1.5, O: 1.5, C: 0.5 } },
    { label: 'Zdravstvo & Psihologija', desc: 'Pomažeš ljudima da čuvaju zdravlje — fizičko ili mentalno. Od medicine i terapije do welness-a i koučinga.', weights: { P: 2, N: 1.5 } },
    { label: 'Prodaja & Razvoj biznisa', desc: 'Pronalaziš nove klijente i zatvараš poslove. Gradiš odnose koji donose prihod kompaniji i otvaraš nova tržišta.', weights: { B: 2.5, P: 1.5 } },
  ],
}
...
const strengthsData = {
  ...
  sr: [
    { label: 'Često dolaziš do novih ideja i pronalaziš drugačija rešenja od većine ljudi.', dim: 'C' },
    { label: 'Brzo razumeš kako tehnički sistemi rade i lako rešavaš kompleksne logičke probleme.', dim: 'T' },
    { label: 'Razumeš kako se drugi osećaju i znaš kako da komuniciraš na način koji ljudi primaju dobro.', dim: 'P' },
    { label: 'Prepoznaješ prilike i unapred vidiš kako neka ideja može da se razvija u poslovnom smislu.', dim: 'B' },
    { label: 'Dobro planiraš i organizuješ — stvari kod tebe retko propadaju između koraka.', dim: 'O' },
    { label: 'Kada nešto radiš rukama ili fizički, brzo dostižeš visok nivo kvaliteta.', dim: 'N' },
    { label: 'Kada rešavaš problem sam/a, postigeš visoku koncentraciju i dubok fokus.', dim: 'I' },
    { label: 'Energija ti raste kada si u timu — imaš prirodnu sposobnost da motivišeš ljude oko sebe.', dim: 'E' },
    { label: 'Nisi paralizovan/a neizvesnosću — spreman/a si da kreneš pre nego što sve bude savršeno.', dim: 'R' },
    { label: 'Ljudi znaju da mogu da se oslone na tebe — postavljaš standard i dosledno ga ispunjavaš.', dim: 'S' },
  ],
}

export const dimDescriptions = {
  sr: {
    C: 'Kreativnost — koliko prirodno dolaziš do novih ideja, originalnih pristupa i vizuelnog razmišljanja. Visok skor znači da ti kreativni rad dolazi intuitivno.',
    T: 'Tehnologija — koliko lako razumeš kako digitalni sistemi i alati rade. Visok skor znači da ti logika, programiranje i tehničko razmišljanje dolaze lakše nego proseku.',
    P: 'Rad sa ljudima — koliko ti je prirodno da razumeš, pomažeš i komuniciraš sa drugima. Visok skor znači da ti posao koji uključuje saradnju ili vođenje dolazi prirodno.',
    B: 'Biznis — koliko razmišljaš u terminima rezultata, rasta i mogućnosti. Visok skor znači da ti strategija, prodaja i preduzetničko razmišljanje dolaze intuitivno.',
    O: 'Organizacija — koliko voliš red, planiranje i jasne procese. Visok skor znači da se odlično snalaziš u koordinaciji, upravljanju i sistematičnom radu.',
    N: 'Praktičan rad — koliko ti odgovara fizički ili rukama orijentisan rad. Visok skor znači da ti bolje ide kad možeš da napraviš ili uradiš nešto konkretno.',
  },
}
